...
class IRealEstateContent(Interface):
    ...
    floor_area = schema.TextLine(
        title = _(u'Floor area'),
        )
    ...
    geolocation = schema.TextLine(
        # Well, right, textline... it are two int fields, really.
        title = _(u'Location'),
        )
...
class IResidential(IRealEstateContent):
    ...
    kindOfStorage = schema.TextLine(
        title = _(u'Kind of storage'),
        description = _(u'You can choose more than one option.'),
        )
